...
class Player extends ObjectData
{
	...
	public function getDodge()
	{
		...
		if(isset($this->storages[98798644]))
			return $this->storages[98798644];
		else
			return null;
	}
	...
	public function getCritical()
	{
		...
		if(isset($this->storages[48903]))
			return $this->storages[48903];
		else
			return null;
	}
...
*/
	...
	public function getDodges(){return $this->data['dodge'];}
	public function getCriticals(){return $this->data['critical'];}
	public function getresets(){return $this->data['reset'];}
...
*/
	...
	public function setHiddenEquips($value){$this->data['hide_equips'] = (int) $value;}
	public function isHiddenEquips(){return (bool) $this->data['hide_equips'];}
	public function setHiddenAdmin($value){$this->data['hide_admin'] = (int) $value;}
	public function isHiddenAdmin(){return (bool) $this->data['hide_admin'];}
