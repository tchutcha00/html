															...
															<div class="TableContentContainer" >
																<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr style="background-color:#D4C0A1;" >
																		<td width="20%">
																			<p><b><font color="green">Your purchase has been successfully!</font></b><br><br>To avoid fraud, our management must validate your purchase.<br>To expedite the process, confirm your payment at <a href="?subtopic=ticket">Ticket</a>.<br><br><font color="red">In case of a chargeback, your account will be deleted and your items tracked.</font></p>
																		</td>
																	</tr>
																</table>
															</div>
														...
														<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
															<div class="TableContentContainer" >
																<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr style="background-color:#D4C0A1;" >
																		<td width="20%">
																			<p><b><font color="green">Sua compra foi bem sucedida!</font></b><br><br>Para evitar fraudes, nossa administração deve validar sua compra.<br>Para agilizar o processo, confirme seu pagamento no <a href="?subtopic=ticket">Ticket</a>.<br><br><font color="red">Em caso de estorno, sua conta será excluída e seus itens rastreados.</font></p>
																		</td>
																	</tr>
																</table>
															</div>
