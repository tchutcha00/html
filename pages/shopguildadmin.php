...
if($group_id_of_acc_logged >= $config['site']['access_admin_panel']) {
   		 ...
   		 $main_content .= '<br>
														...
														<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
															<div class="TableContentContainer" >
																<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr>
																		<td><center><h1>SHOP GUILD ADMIN SYSTEM</h1><br><font size="5"><a href="?subtopic=shopguildadmin&action=addoffer">ADICIONAR NOVO ITEM</a></font></center></td>
																	</tr>									
																</table>
															</div>
														</div>											
														...
														<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
															<div class="TableContentContainer" >
																<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr>
																		<td><center><font color="green"><h1>GUILD ADMIN SYSTEM</h1></font><br><font size="5"><a href="?subtopic=shopguildadmin&action=points">ADICIONA PONTOS</a></font></center></td>
																	</tr>									
																</table>
															</div>
														</div>											
	...
	if($action == "addoffer"){
		...
		if(empty($shop_points)) {
			$main_content .= '<table border="0"><tr><td  align="center"><b>Select offer type:</b></td><td><table border="0" ><tr bgcolor="#505050">
				...
				<td><font color="white">Unban</td><td><font color="white">Changename</td><td><font color="white">Outfit</td></tr><tr bgcolor="#D4C0A1"><form action="" method="post">
				...
				<td align="center"><input type="radio" name="offer_type" value="outfit" onClick="this.form.submit()"></td>
				</form></tr></table></td></tr>';
			...
			if($_REQUEST['offer_type'] == 'outfit')
				$main_content .= '
				<tr><td align="center" ><b>Offer Name:</b></td>
					<td><select name="shop_offer_name">
					  <option value="Citizen">Citizen</option>
					  <option value="Hunter">Hunter</option>
					  <option value="Mage">Mage</option>
					  <option value="Knight">Knight</option>
					  <option value="Noblewoman">Noblewoman</option>
					  ...
					  <option value="Norsewoman">Norsewoman</option>
					  <option value="Nightmare">Nightmare</option>
					  <option value="Jester">Jester</option>
					  <option value="Brotherhood">Brotherhood</option>
					  <option value="Demonhunter">Demonhunter</option>
					  <option value="Yalaharian">Yalaharian</option>
	...
	if($action == "points") {
		...
		$points = $_POST['points'];
		if(empty($player)) {
			$main_content .= '<center><font color="lime"><h1>SHOP GUILD ADMIN</h1></font><form action="?subtopic=shopguildadmin&action=points" method="post"><B>Jogador:</B> <input type="textbox" name="character"><br>
				<B>Total Pontos: </B><input type="textbox" name="points"><br><br><input type="submit" value="Submit">
            ...
            $main_content .= '<center><h1>GUILD SHOP PONTOS ATIVADOS</h1><b>Atenção um total de <font color="lime"><br><h1>'.$points.'</h1></font> Retro Points foram adicionados a conta do jogador <font color="blue"><h1><br><i>'.$player.'!</i></h1></font></b></center><br>
