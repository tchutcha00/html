   		 ...
   		 $main_content .= '<br>
														...
														<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
															<div class="TableContentContainer" >
																<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr>
																		<td><center><font size="5"><a href="?subtopic=shopadmin&action=addoffer">ADD SHOP OFFER</a></font></center></td>
																	</tr>									
																</table>
															</div>
														</div>											
														...
														<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
															<div class="TableContentContainer" >
																<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr>
																		<td><center><font size="5"><a href="?subtopic=shopadmin&action=points">ADD POINTS</a></font></center></td>
																	</tr>									
																</table>
															</div>
														</div>											
