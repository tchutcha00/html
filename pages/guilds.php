...
if($action == '')
{
	...
	$main_content .= '
	<h2><center>Guilds on '.htmlspecialchars($world_name).'</center></h2>
		<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=4 WIDTH=100%>
			<TR BGCOLOR='.$config['site']['vdarkborder'].'>
				<TD COLSPAN=3 CLASS=white><B>Guilds on '.htmlspecialchars($world_name).'</B></TD>
				<TR COLSPAN=3>
					' . (!count($guilds_list) ? '' 
						: 
							($logged ? '
								<div style="text-align: center; margin-bottom: 10px" ><FORM ACTION="?subtopic=guilds&action=createguild" METHOD=post>
							...
							' 
							: '<h4 style="text-align: center">Before you can create guild you must login.<br><FORM ACTION="?subtopic=accountmanagement" METHOD=post>
	...
	if($logged)
		...
		$main_content .= 'Before you can create guild you must login.<br><TABLE BORDER=0 WIDTH=100%><TR><TD ALIGN=center><IMG SRC="'.$layout_name.'/images/blank.gif" WIDTH=80 HEIGHT=1 BORDER=0<BR></TD><TD ALIGN=center><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0><FORM ACTION="?subtopic=accountmanagement" METHOD=post><TR><TD>
		<INPUT TYPE=image NAME="Login" ALT="Login" SRC="'.$layout_name.'/images/buttons/sbutton_login.gif" BORDER=0 WIDTH=120 HEIGHT=18>
		</TD></TR></FORM></TABLE></TD><TD ALIGN=center><IMG SRC="'.$layout_name.'/images/blank.gif" WIDTH=80 HEIGHT=1 BORDER=0<BR></TD></TR></TABLE>';
}
//-----------------------------------------------------------------------------//-----------------------------------------------------------------------------
...
if($action == 'createguild')
{
	...
	if($todo == 'save')
	{
		...
		$new_guild->setDescription('Guild nova aguardando o lider editar a desc.');
